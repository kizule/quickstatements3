...
class ProcessingTests(TestCase):
    ...
    def test_get_label(self, mocker):
        ...
        print(commands[0].labels)
        print(commands[0].json)
        print(commands[0].entity_id())
        print(commands[1].labels)
        print(commands[1].json)
        print(commands[1].entity_id())
        print(commands[2].labels)
        print(commands[2].json)
        print(commands[2].entity_id())
